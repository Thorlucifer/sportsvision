...
def show():
    ...
    <li><strong>Our goal is to give coaches, athletes, and analysts precise, up-to-date information so they can make wise decisions, perform better, and take greater pleasure in the game. Our technology provides accurate object recognition and tactical analysis through the use of deep learning models and powerful computer vision techniques, guaranteeing that you never miss a crucial moment on the court.</strong></li>
    </ul>
    </div>
    </div>
    """,
